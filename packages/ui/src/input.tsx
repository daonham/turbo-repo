    ...
    <div>
      <div className="relative flex">
        <input
          ...
          className={cn(
            'w-full max-w-md rounded-lg border border-gray-300 text-gray-900 placeholder-gray-400 focus:border-gray-600 focus:outline-none focus:ring-gray-600 sm:text-sm',
